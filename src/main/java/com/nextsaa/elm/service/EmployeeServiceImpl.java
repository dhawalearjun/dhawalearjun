...
import com.nextsaa.elm.dto.EmployeeDTO;
import com.nextsaa.elm.entity.Employee;
import com.nextsaa.elm.exceptions.DataConflictException;
import com.nextsaa.elm.exceptions.DataNotFoundException;
import com.nextsaa.elm.mapper.EmployeeMapper;
...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public EmployeeDTO createEmployee(EmployeeDTO employeeDTO) {
        ...
        employeeDTO.setCreatedBy(ExtractUserAuthentication.getCurrentUser().getUsername());
        employeeDTO.setModifiedBy(ExtractUserAuthentication.getCurrentUser().getUsername());
